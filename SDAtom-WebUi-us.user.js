...
(function() {
    ...
    function awqLogPublishMsg(p_message, p_error) {
        ...
        if(lines.length >= c_maxOutputLines) {
            lines[0].parentNode.removeChild(lines[0]);
        }
        conf.ui.outputConsole.scrollTo(0, conf.ui.outputConsole.scrollHeight);
        awqLog(p_message);
    }
    ...
    function generateQueueUI() {
        ...
        notificationSoundCheckbox.onclick = function() {localStorage.awqNotificationSound = localStorage.awqNotificationSound == 1 ? 0 : 1;};
        notificationSoundCheckbox.checked = (localStorage.awqNotificationSound == 1 ? true : false)
        ...
        outputConsole.placeholder = "Script logg output";
        outputConsole.title = "Here you will se some information about what the script is doing";
        ...
        outputConsole.style.height = (16*5)+"px";
    ...
    function appendQueueItem(p_quantity, p_value, p_type) {
        ...
        awqLogPublishMsg(`Added new ${itemType.value} queue item`);
    ...
    function toggleProcessButton(p_set_processing) {
        ...
        if(undefinedInput) {
            ...
            awqLogPublishMsg('Processing activated');
            ...
            awqLogPublishMsg('Processing deactivated');
